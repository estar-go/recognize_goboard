...
class Config(object):
    ...
    print_iter = 2
    resume_epoch = 0
    model_output_base_path = f'/data/projects/weights/training/goboard_recogn/work_dir/classifier_{cnn_type}_{optims_type}_' + time.strftime('%Y%m%d-%H%M', time.localtime())[:-1]  
    log_name = '/train.log'
